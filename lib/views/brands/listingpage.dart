                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "HSN: 848180",
                        style: GoogleFonts.instrumentSans(fontSize: 10, color: Colors.black),
                      ),
                      const SizedBox(height: 8),
                      Text(
                        "Lineare 1-Handle Basin Mixer without Pop-Up, XL Size",
                        style: GoogleFonts.instrumentSans(fontSize: 12, fontWeight: FontWeight.bold),
                      ),
                      const SizedBox(height: 8),
                      Row(
                        children: [
                          Column(
                            children: [
                              Text(
                                'MRP',
                                style: GoogleFonts.instrumentSans(fontSize: 12, color: Colors.black, fontWeight: FontWeight.w200),
                              )
                            ],
                          ),
                          SizedBox(width: 10),
                      ...
                      ElevatedButton(
                        ...
                        child: Text(
                          'Add to Quote',
                          style: GoogleFonts.instrumentSans(color: Colorconstants.primaryColor, fontSize: 12,),
                        ),
                      )
                    ],
                  ),
