...
import 'package:hemantenterprisesstaff/models/createaccountmodel.dart';
import 'package:hemantenterprisesstaff/models/elevatedbuttonmodel.dart';
import 'package:hemantenterprisesstaff/routes/app_routes.dart'; // Import fluttertoast package
    ...
    if (!_isLoading) {
      ...
      if (_formKey.currentState!.validate()) {
          ...
          await FirebaseAuth.instance.verifyPhoneNumber(
            ...
            codeSent: (String verificationId, int? resendToken) {
              ...
              Fluttertoast.showToast(
                ...
                backgroundColor: Colorconstants.primaryColor, // Toast background color.
              );
        ...
        Fluttertoast.showToast(
          ...
          backgroundColor: Colorconstants.darkBlack, // Toast background color.
