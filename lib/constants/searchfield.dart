    ...
    return AppBar(
      ...
      actions: [
        PopupMenuButton<int>(
          ...
          offset: Offset(10, 50), // Adjust position of popup
          onSelected: (value) {
            if (value == 1) {
              Get.toNamed(AppRoutes.customerQuotes);
            } else if (value == 2) {
            ...
            PopupMenuItem(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    "Customer Quotes",
                    style: GoogleFonts.instrumentSans(fontSize: 14, fontWeight: FontWeight.w500, color: Colorconstants.primaryColor),
                  ),
                ),
              ),
            ),
